...
date: 2026-08-05
type: website-copy
tags: [resume, website, portfolio, truly-engaging]
status: draft-final
repo: https://github.com/Ghias54/Personal-Website
---

## For future Claude
Web version of the MOLL capacity analysis case study for [[People/Rehan Ghias]]'s personal website. Condensed and simplified from [[Resume/MOLL Capacity Analysis Writeup]] for a non-technical hiring manager. Companion: [[Resume/Website/Home Page Copy]].

Deliberate choices: no measured improvement percentage is claimed. The ~30% run time figure is labelled explicitly as an operator estimate, not a measurement, because post-intervention data was never accessible. Do not convert it into a hard claim. Machines are called "Machine 1 / Machine 2" rather than Moll 1 / Moll 2 for readability.

Open items: three images still needed (whiteboard photo, raw data screenshot, a chart). The page never states a final daily capacity number, which was the original question — decide whether to add one or state that capacity depends on job mix.

---

# Finding the Real Capacity of a Die-Cutting Machine

Truly Engaging | Operational analysis | Excel, Power BI
...
[IMAGE: chart showing time breakdown or No Read by job type]
